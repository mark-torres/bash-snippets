...
convert $1 -resize ${SIZE_1X} -colorspace sRGB $CWD/${NAME}_${3}pt_1x.${FILE_EXT}
convert $1 -resize ${SIZE_2X} -colorspace sRGB $CWD/${NAME}_${3}pt_2x.${FILE_EXT}
convert $1 -resize ${SIZE_3X} -colorspace sRGB $CWD/${NAME}_${3}pt_3x.${FILE_EXT}
